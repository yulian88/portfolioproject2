...
!function (t, e) {
    ...
    return function (t) {
        ...
        var p = function (t) {
            ...
            }(t), n = e.string, i = e.nodes, r = c(n).split(""), o = [];
            return r.forEach(function (t, e) {
                if (r.slice(e, e + 3).join("") === h) {
                    var n = e, s = i.shift(), a = c(s.innerHTML).split(""),
            ...
            var e = t.tag, n = t.attributes, i = void 0 === n ? [] : n, r = t.content, o = void 0 === r ? "" : r,
        ...
        var k = "display:inline;position:relative;font:inherit;color:inherit;line-height:inherit;", q = function () {
            function t() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = e.element, r = e.id,
                    o = e.options, s = e.queue, c = void 0 === s ? [] : s;
                !function (t, e) {
                    if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                }(this, t), this.status = {
                    started: !1,
            ...
            return e = t, (n = [{
                ...
                key: "queueDeletions", value: function () {
                ...
                key: "maybeNoderize", value: function (t) {
                    return this.opts.html ? p(t) : t.split("")
                }
            }, {
                key: "queueString", value: function (t) {
                    var e = this, n = (t = this.maybeNoderize(t)).length;
                ...
                key: "addSplitPause", value: function (t) {
                ...
                key: "handleHardCoded", value: function (t) {
                ...
                key: "wait", value: function (t, e) {
                    this.timeouts.push(setTimeout(t, e))
                }
            }, {
                key: "setPace", value: function () {
                    var t = this.opts.speed,
                        e = null !== this.opts.deleteSpeed ? this.opts.deleteSpeed : this.opts.speed / 3, n = t / 2,
                        i = e / 2;
